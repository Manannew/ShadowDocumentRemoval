...
#ifndef MYAPPLICATION42_SHADOWREMOVER_H
#define MYAPPLICATION42_SHADOWREMOVER_H
...
JNIEXPORT void JNICALL Java_com_example_myapplication4_NativeClass_removeShadow(JNIEnv *, jclass, jstring);
...
#endif //MYAPPLICATION42_SHADOWREMOVER_H
